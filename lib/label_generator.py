...
Para la impresión usaremos el comando lp -d lanzado desde subprocess.run y le pasamos como parámetros
    -o oriented-requested=3 para asegurarnos que la impresión se realiza en el sentido de alimentación de la cinta
    ...
    Ejemplo: subprocess.run(["lp","-o","oriented_requested=3","-d", "Brother_12", etiqueta])
...
def Impr_Israel_label(PartName):
    ...
    # Mandamos a impresión la etiqueta
    subprocess.run(["lp","-o","oriented_requested=3","-d", IMPRESORA, ETIQUETA])
